        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Ingredient>()
                .HasData(
                    ...
                    new Ingredient { IngredientId = 6, Name = "Tonato" }
                   );

            builder.Entity<Product>()
                .HasData(
                    new Product { ProductId=1 , Name="Beef Taco" , Description="A delcious beef taco", Price=2.50m , Stock=100,CategoryId=2},
                    new Product { ProductId = 2, Name = "Chicken Taco", Description = "A delcious chicken taco", Price = 1.99m, Stock = 101, CategoryId = 2 },
                    new Product { ProductId = 3, Name = "Fish Taco", Description = "A delcious fish taco", Price = 3.99m, Stock = 90, CategoryId = 2 }
                );
